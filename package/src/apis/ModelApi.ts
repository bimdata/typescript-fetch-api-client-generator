...
import {
    ...
    ModelToJSON,
    ModelEquipment,
    ModelEquipmentFromJSON,
    ModelEquipmentToJSON,
    ModelEquipmentRequest,
    ModelEquipmentRequestFromJSON,
    ModelEquipmentRequestToJSON,
    ModelErrors,
    ModelErrorsFromJSON,
    ModelErrorsToJSON,
    ModelErrorsRequest,
    ...
    PatchedModelEquipmentRequestFromJSON,
    PatchedModelEquipmentRequestToJSON,
...
export interface AddEquipmentTagsRequest {
    cloud_pk: number;
    equipment_pk: number;
    model_pk: number;
    project_pk: number;
...
export interface CreateEquipmentRequest {
    ...
    model_pk: number;
    project_pk: number;
    ModelEquipmentRequest: ModelEquipmentRequest;
}
...
export interface CreateMultiPageModelOperationRequest {
    cloud_pk: number;
    id: number;
    project_pk: number;
...
export interface GetEquipmentTagsRequest {
    cloud_pk: number;
    equipment_pk: number;
    model_pk: number;
    project_pk: number;
...
export interface RemoveEquipmentTagRequest {
    cloud_pk: number;
    equipment_pk: number;
    id: number;
    model_pk: number;
...
export interface UpdateEquipmentRequest {
    ...
    model_pk: number;
    project_pk: number;
    PatchedModelEquipmentRequest?: PatchedModelEquipmentRequest;
}
...
export interface UpdateMask2DRequest {
    ...
    id: number;
    project_pk: number;
    PatchedMask2DRequest?: PatchedMask2DRequest;
}
...
export class ModelApi extends runtime.BaseAPI {
     ...
     * Add one or many tags to an equipment
     */
    async addEquipmentTagsRaw(requestParameters: AddEquipmentTagsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<Tag>>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
            throw new runtime.RequiredError('cloud_pk','Required parameter requestParameters.cloud_pk was null or undefined when calling addEquipmentTags.');
        }

        if (requestParameters.equipment_pk === null || requestParameters.equipment_pk === undefined) {
            throw new runtime.RequiredError('equipment_pk','Required parameter requestParameters.equipment_pk was null or undefined when calling addEquipmentTags.');
        }

        if (requestParameters.model_pk === null || requestParameters.model_pk === undefined) {
            throw new runtime.RequiredError('model_pk','Required parameter requestParameters.model_pk was null or undefined when calling addEquipmentTags.');
        }

        if (requestParameters.project_pk === null || requestParameters.project_pk === undefined) {
            throw new runtime.RequiredError('project_pk','Required parameter requestParameters.project_pk was null or undefined when calling addEquipmentTags.');
        }

        if (requestParameters.request_body === null || requestParameters.request_body === undefined) {
            throw new runtime.RequiredError('request_body','Required parameter requestParameters.request_body was null or undefined when calling addEquipmentTags.');
        }
        ...
        const response = await this.request({
            path: `/cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/equipment/{equipment_pk}/tag`.replace(`{${"cloud_pk"}}`, encodeURIComponent(String(requestParameters.cloud_pk))).replace(`{${"equipment_pk"}}`, encodeURIComponent(String(requestParameters.equipment_pk))).replace(`{${"model_pk"}}`, encodeURIComponent(String(requestParameters.model_pk))).replace(`{${"project_pk"}}`, encodeURIComponent(String(requestParameters.project_pk))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
     ...
     * Add one or many tags to an equipment
     */
    async addEquipmentTags(cloud_pk: number, equipment_pk: number, model_pk: number, project_pk: number, request_body: Array<number>, initOverrides?: RequestInit): Promise<Array<Tag>> {
        const response = await this.addEquipmentTagsRaw({ cloud_pk: cloud_pk, equipment_pk: equipment_pk, model_pk: model_pk, project_pk: project_pk, request_body: request_body }, initOverrides);
        return await response.value();
    }
     ...
     */
    async createEquipmentRaw(requestParameters: CreateEquipmentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelEquipment>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
            throw new runtime.RequiredError('cloud_pk','Required parameter requestParameters.cloud_pk was null or undefined when calling createEquipment.');
        }

        if (requestParameters.model_pk === null || requestParameters.model_pk === undefined) {
            throw new runtime.RequiredError('model_pk','Required parameter requestParameters.model_pk was null or undefined when calling createEquipment.');
        }

        if (requestParameters.project_pk === null || requestParameters.project_pk === undefined) {
            throw new runtime.RequiredError('project_pk','Required parameter requestParameters.project_pk was null or undefined when calling createEquipment.');
        }

        if (requestParameters.ModelEquipmentRequest === null || requestParameters.ModelEquipmentRequest === undefined) {
            throw new runtime.RequiredError('ModelEquipmentRequest','Required parameter requestParameters.ModelEquipmentRequest was null or undefined when calling createEquipment.');
        }
        ...
        const response = await this.request({
            path: `/cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/equipment`.replace(`{${"cloud_pk"}}`, encodeURIComponent(String(requestParameters.cloud_pk))).replace(`{${"model_pk"}}`, encodeURIComponent(String(requestParameters.model_pk))).replace(`{${"project_pk"}}`, encodeURIComponent(String(requestParameters.project_pk))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: ModelEquipmentRequestToJSON(requestParameters.ModelEquipmentRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelEquipmentFromJSON(jsonValue));
    }
     ...
     * Create an equipment on the model
     */
    async createEquipment(cloud_pk: number, model_pk: number, project_pk: number, ModelEquipmentRequest: ModelEquipmentRequest, initOverrides?: RequestInit): Promise<ModelEquipment> {
        const response = await this.createEquipmentRaw({ cloud_pk: cloud_pk, model_pk: model_pk, project_pk: project_pk, ModelEquipmentRequest: ModelEquipmentRequest }, initOverrides);
        return await response.value();
    }
     ...
     */
    async createMultiPageModelRaw(requestParameters: CreateMultiPageModelOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Model>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
            throw new runtime.RequiredError('cloud_pk','Required parameter requestParameters.cloud_pk was null or undefined when calling createMultiPageModel.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling createMultiPageModel.');
        }

        if (requestParameters.project_pk === null || requestParameters.project_pk === undefined) {
            throw new runtime.RequiredError('project_pk','Required parameter requestParameters.project_pk was null or undefined when calling createMultiPageModel.');
        }

        if (requestParameters.CreateMultiPageModelRequest === null || requestParameters.CreateMultiPageModelRequest === undefined) {
            throw new runtime.RequiredError('CreateMultiPageModelRequest','Required parameter requestParameters.CreateMultiPageModelRequest was null or undefined when calling createMultiPageModel.');
        }
        ...
        const response = await this.request({
            path: `/cloud/{cloud_pk}/project/{project_pk}/model/{id}/create-multipage-model`.replace(`{${"cloud_pk"}}`, encodeURIComponent(String(requestParameters.cloud_pk))).replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))).replace(`{${"project_pk"}}`, encodeURIComponent(String(requestParameters.project_pk))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
     ...
     * Delete an equipment
     */
    async deleteEquipmentRaw(requestParameters: DeleteEquipmentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
            throw new runtime.RequiredError('cloud_pk','Required parameter requestParameters.cloud_pk was null or undefined when calling deleteEquipment.');
        }
        ...
        if (requestParameters.model_pk === null || requestParameters.model_pk === undefined) {
            throw new runtime.RequiredError('model_pk','Required parameter requestParameters.model_pk was null or undefined when calling deleteEquipment.');
        }

        if (requestParameters.project_pk === null || requestParameters.project_pk === undefined) {
            throw new runtime.RequiredError('project_pk','Required parameter requestParameters.project_pk was null or undefined when calling deleteEquipment.');
        }
        ...
        const response = await this.request({
            path: `/cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/equipment/{id}`.replace(`{${"cloud_pk"}}`, encodeURIComponent(String(requestParameters.cloud_pk))).replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))).replace(`{${"model_pk"}}`, encodeURIComponent(String(requestParameters.model_pk))).replace(`{${"project_pk"}}`, encodeURIComponent(String(requestParameters.project_pk))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Delete an equipment
     */
    async deleteEquipment(cloud_pk: number, id: number, model_pk: number, project_pk: number, initOverrides?: RequestInit): Promise<void> {
        await this.deleteEquipmentRaw({ cloud_pk: cloud_pk, id: id, model_pk: model_pk, project_pk: project_pk }, initOverrides);
    }
     ...
     * Export IFC
     */
    async exportIfcRaw(requestParameters: ExportIfcRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
     ...
     * Export IFC
     */
    async exportIfc(cloud_pk: number, id: number, project_pk: number, IfcExportRequest: IfcExportRequest, initOverrides?: RequestInit): Promise<void> {
        await this.exportIfcRaw({ cloud_pk: cloud_pk, id: id, project_pk: project_pk, IfcExportRequest: IfcExportRequest }, initOverrides);
    }
     ...
     */
    async getEquipmentRaw(requestParameters: GetEquipmentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelEquipment>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
            throw new runtime.RequiredError('cloud_pk','Required parameter requestParameters.cloud_pk was null or undefined when calling getEquipment.');
        }
        ...
        if (requestParameters.model_pk === null || requestParameters.model_pk === undefined) {
            throw new runtime.RequiredError('model_pk','Required parameter requestParameters.model_pk was null or undefined when calling getEquipment.');
        }

        if (requestParameters.project_pk === null || requestParameters.project_pk === undefined) {
            throw new runtime.RequiredError('project_pk','Required parameter requestParameters.project_pk was null or undefined when calling getEquipment.');
        }
    ...
    /**
     * Retrieve all tags of an equipment  Required scopes: ifc:read, model:read
     * Retrieve all tags of an equipment
     */
    async getEquipmentTagsRaw(requestParameters: GetEquipmentTagsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<Tag>>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
            throw new runtime.RequiredError('cloud_pk','Required parameter requestParameters.cloud_pk was null or undefined when calling getEquipmentTags.');
        }

        if (requestParameters.equipment_pk === null || requestParameters.equipment_pk === undefined) {
            throw new runtime.RequiredError('equipment_pk','Required parameter requestParameters.equipment_pk was null or undefined when calling getEquipmentTags.');
        }

        if (requestParameters.model_pk === null || requestParameters.model_pk === undefined) {
            throw new runtime.RequiredError('model_pk','Required parameter requestParameters.model_pk was null or undefined when calling getEquipmentTags.');
        }

        if (requestParameters.project_pk === null || requestParameters.project_pk === undefined) {
            throw new runtime.RequiredError('project_pk','Required parameter requestParameters.project_pk was null or undefined when calling getEquipmentTags.');
        }
     ...
     * Retrieve all tags of an equipment
     */
    async getEquipmentTags(cloud_pk: number, equipment_pk: number, model_pk: number, project_pk: number, initOverrides?: RequestInit): Promise<Array<Tag>> {
        const response = await this.getEquipmentTagsRaw({ cloud_pk: cloud_pk, equipment_pk: equipment_pk, model_pk: model_pk, project_pk: project_pk }, initOverrides);
        return await response.value();
    }
     ...
     */
    async getEquipmentsRaw(requestParameters: GetEquipmentsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<ModelEquipment>>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
            throw new runtime.RequiredError('cloud_pk','Required parameter requestParameters.cloud_pk was null or undefined when calling getEquipments.');
        }

        if (requestParameters.model_pk === null || requestParameters.model_pk === undefined) {
            throw new runtime.RequiredError('model_pk','Required parameter requestParameters.model_pk was null or undefined when calling getEquipments.');
        }

        if (requestParameters.project_pk === null || requestParameters.project_pk === undefined) {
            throw new runtime.RequiredError('project_pk','Required parameter requestParameters.project_pk was null or undefined when calling getEquipments.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(ModelEquipmentFromJSON));
    }
     ...
     * Retrieve all equipments of the model
     */
    async getEquipments(cloud_pk: number, model_pk: number, project_pk: number, initOverrides?: RequestInit): Promise<Array<ModelEquipment>> {
        const response = await this.getEquipmentsRaw({ cloud_pk: cloud_pk, model_pk: model_pk, project_pk: project_pk }, initOverrides);
        return await response.value();
    }
    ...
    async linkDocumentsOfElementRaw(requestParameters: LinkDocumentsOfElementRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<Document>>> {
        ...
        if (requestParameters.request_body === null || requestParameters.request_body === undefined) {
            throw new runtime.RequiredError('request_body','Required parameter requestParameters.request_body was null or undefined when calling linkDocumentsOfElement.');
        }
    ...
    async linkDocumentsOfElement(cloud_pk: number, element_uuid: string, model_pk: number, project_pk: number, request_body: Array<number>, initOverrides?: RequestInit): Promise<Array<Document>> {
        const response = await this.linkDocumentsOfElementRaw({ cloud_pk: cloud_pk, element_uuid: element_uuid, model_pk: model_pk, project_pk: project_pk, request_body: request_body }, initOverrides);
        return await response.value();
    }
    ...
    /**
     * Remove a tag from an equipment, the tag will not be deleted  Required scopes: ifc:write, model:write
     * Remove a tag from an equipment
     */
    async removeEquipmentTagRaw(requestParameters: RemoveEquipmentTagRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
            throw new runtime.RequiredError('cloud_pk','Required parameter requestParameters.cloud_pk was null or undefined when calling removeEquipmentTag.');
        }

        if (requestParameters.equipment_pk === null || requestParameters.equipment_pk === undefined) {
            throw new runtime.RequiredError('equipment_pk','Required parameter requestParameters.equipment_pk was null or undefined when calling removeEquipmentTag.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling removeEquipmentTag.');
        }

        if (requestParameters.model_pk === null || requestParameters.model_pk === undefined) {
            throw new runtime.RequiredError('model_pk','Required parameter requestParameters.model_pk was null or undefined when calling removeEquipmentTag.');
        }

        if (requestParameters.project_pk === null || requestParameters.project_pk === undefined) {
            throw new runtime.RequiredError('project_pk','Required parameter requestParameters.project_pk was null or undefined when calling removeEquipmentTag.');
        }
        ...
        const response = await this.request({
            path: `/cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/equipment/{equipment_pk}/tag/{id}`.replace(`{${"cloud_pk"}}`, encodeURIComponent(String(requestParameters.cloud_pk))).replace(`{${"equipment_pk"}}`, encodeURIComponent(String(requestParameters.equipment_pk))).replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))).replace(`{${"model_pk"}}`, encodeURIComponent(String(requestParameters.model_pk))).replace(`{${"project_pk"}}`, encodeURIComponent(String(requestParameters.project_pk))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Remove a tag from an equipment
     */
    async removeEquipmentTag(cloud_pk: number, equipment_pk: number, id: number, model_pk: number, project_pk: number, initOverrides?: RequestInit): Promise<void> {
        await this.removeEquipmentTagRaw({ cloud_pk: cloud_pk, equipment_pk: equipment_pk, id: id, model_pk: model_pk, project_pk: project_pk }, initOverrides);
    }
     ...
     */
    async updateEquipmentRaw(requestParameters: UpdateEquipmentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelEquipment>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
            throw new runtime.RequiredError('cloud_pk','Required parameter requestParameters.cloud_pk was null or undefined when calling updateEquipment.');
        }
        ...
        if (requestParameters.model_pk === null || requestParameters.model_pk === undefined) {
            throw new runtime.RequiredError('model_pk','Required parameter requestParameters.model_pk was null or undefined when calling updateEquipment.');
        }

        if (requestParameters.project_pk === null || requestParameters.project_pk === undefined) {
            throw new runtime.RequiredError('project_pk','Required parameter requestParameters.project_pk was null or undefined when calling updateEquipment.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PatchedModelEquipmentRequestToJSON(requestParameters.PatchedModelEquipmentRequest),
        }, initOverrides);
     ...
     * Update some fields of an equipment
     */
    async updateEquipment(cloud_pk: number, id: number, model_pk: number, project_pk: number, PatchedModelEquipmentRequest?: PatchedModelEquipmentRequest, initOverrides?: RequestInit): Promise<ModelEquipment> {
        const response = await this.updateEquipmentRaw({ cloud_pk: cloud_pk, id: id, model_pk: model_pk, project_pk: project_pk, PatchedModelEquipmentRequest: PatchedModelEquipmentRequest }, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateMask2DRaw(requestParameters: UpdateMask2DRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Mask2D>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
            throw new runtime.RequiredError('cloud_pk','Required parameter requestParameters.cloud_pk was null or undefined when calling updateMask2D.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling updateMask2D.');
        }

        if (requestParameters.project_pk === null || requestParameters.project_pk === undefined) {
            throw new runtime.RequiredError('project_pk','Required parameter requestParameters.project_pk was null or undefined when calling updateMask2D.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PatchedMask2DRequestToJSON(requestParameters.PatchedMask2DRequest),
        }, initOverrides);
     ...
     * Partial update of a 2D mask for the model
     */
    async updateMask2D(cloud_pk: number, id: number, project_pk: number, PatchedMask2DRequest?: PatchedMask2DRequest, initOverrides?: RequestInit): Promise<Mask2D> {
        const response = await this.updateMask2DRaw({ cloud_pk: cloud_pk, id: id, project_pk: project_pk, PatchedMask2DRequest: PatchedMask2DRequest }, initOverrides);
        return await response.value();
    }
    ...
    async updateModelFilesRaw(requestParameters: UpdateModelFilesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ModelFiles>> {
        ...
        if (requestParameters.fragments_file !== undefined) {
            formParams.append('fragments_file', requestParameters.fragments_file as any);
        }
     ...
     * Update models file (gltf, svg, structure, etc)
     */
    async updateModelFiles(cloud_pk: number, id: number, project_pk: number, structure_file?: Blob | null, systems_file?: Blob | null, map_file?: Blob | null, gltf_file?: Blob | null, preview_file?: Blob | null, xkt_file?: Blob | null, fragments_file?: Blob | null, binary_2d_file?: Blob | null, initOverrides?: RequestInit): Promise<ModelFiles> {
        const response = await this.updateModelFilesRaw({ cloud_pk: cloud_pk, id: id, project_pk: project_pk, structure_file: structure_file, systems_file: systems_file, map_file: map_file, gltf_file: gltf_file, preview_file: preview_file, xkt_file: xkt_file, fragments_file: fragments_file, binary_2d_file: binary_2d_file }, initOverrides);
        return await response.value();
    }
