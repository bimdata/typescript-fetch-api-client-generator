...
export interface CreateXktFileDeprecatedRequest {
    cloud_pk: number;
    id: number;
    project_pk: number;
    version: number;
...
export class IfcApi extends runtime.BaseAPI {
     ...
     */
    async createXktFileDeprecatedRaw(requestParameters: CreateXktFileDeprecatedRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<XktFile>> {
        if (requestParameters.cloud_pk === null || requestParameters.cloud_pk === undefined) {
            throw new runtime.RequiredError('cloud_pk','Required parameter requestParameters.cloud_pk was null or undefined when calling createXktFileDeprecated.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling createXktFileDeprecated.');
        }

        if (requestParameters.project_pk === null || requestParameters.project_pk === undefined) {
            throw new runtime.RequiredError('project_pk','Required parameter requestParameters.project_pk was null or undefined when calling createXktFileDeprecated.');
        }

        if (requestParameters.version === null || requestParameters.version === undefined) {
            throw new runtime.RequiredError('version','Required parameter requestParameters.version was null or undefined when calling createXktFileDeprecated.');
        }

        if (requestParameters.file === null || requestParameters.file === undefined) {
            throw new runtime.RequiredError('file','Required parameter requestParameters.file was null or undefined when calling createXktFileDeprecated.');
        }
        ...
        const response = await this.request({
            path: `/cloud/{cloud_pk}/project/{project_pk}/ifc/{id}/xkt-file`.replace(`{${"cloud_pk"}}`, encodeURIComponent(String(requestParameters.cloud_pk))).replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))).replace(`{${"project_pk"}}`, encodeURIComponent(String(requestParameters.project_pk))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: formParams,
     ...
     * Create an xkt file for the model. Overrides existing file with same version
     */
    async createXktFileDeprecated(cloud_pk: number, id: number, project_pk: number, version: number, file: Blob, initOverrides?: RequestInit): Promise<XktFile> {
        const response = await this.createXktFileDeprecatedRaw({ cloud_pk: cloud_pk, id: id, project_pk: project_pk, version: version, file: file }, initOverrides);
        return await response.value();
    }
