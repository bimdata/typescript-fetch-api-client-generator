...
export class IfcApi extends runtime.BaseAPI {
    ...
    async updateOrderBuildingPlanDeprecatedRaw(requestParameters: UpdateOrderBuildingPlanDeprecatedRequest): Promise<runtime.ApiResponse<Storey>> {
        ...
        if (requestParameters.data === null || requestParameters.data === undefined) {
            throw new runtime.RequiredError('data','Required parameter requestParameters.data was null or undefined when calling updateOrderBuildingPlanDeprecated.');
        }
     ...
     * Update order of all plan of a building
     */
    async updateOrderBuildingPlanDeprecated(requestParameters: UpdateOrderBuildingPlanDeprecatedRequest): Promise<Storey> {
        const response = await this.updateOrderBuildingPlanDeprecatedRaw(requestParameters);
        return await response.value();
    }
    ...
    async updateOrderStoreyPlanDeprecatedRaw(requestParameters: UpdateOrderStoreyPlanDeprecatedRequest): Promise<runtime.ApiResponse<Storey>> {
        ...
        if (requestParameters.data === null || requestParameters.data === undefined) {
            throw new runtime.RequiredError('data','Required parameter requestParameters.data was null or undefined when calling updateOrderStoreyPlanDeprecated.');
        }
     ...
     * Update order of all plan of a storey
     */
    async updateOrderStoreyPlanDeprecated(requestParameters: UpdateOrderStoreyPlanDeprecatedRequest): Promise<Storey> {
        const response = await this.updateOrderStoreyPlanDeprecatedRaw(requestParameters);
        return await response.value();
    }
