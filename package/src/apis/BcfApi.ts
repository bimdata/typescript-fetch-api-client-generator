...
export class BcfApi extends runtime.BaseAPI {
     ...
     */
    async downloadBcfExportRaw(requestParameters: DownloadBcfExportRequest): Promise<runtime.ApiResponse<void>> {
     ...
     * Export project\'s topics in bcf-xml format
     */
    async downloadBcfExport(requestParameters: DownloadBcfExportRequest): Promise<void> {
        await this.downloadBcfExportRaw(requestParameters);
    }
